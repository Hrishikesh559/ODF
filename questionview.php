...
<?php
	...
	{	
		...
		while($row1 = mysql_fetch_array($result))
		{
			...
			echo "<span class='box2'>";
			echo "<span class='head'><a href='answer.php?id=$_GET[qid]'>REPLY</a><a href='like.php?id=$row1[answer_id] ' class='view2' >$row1[like]</a> <a href='dwdpap.php?id=$_GET[qid]' class='view2'>Download</a>
</span>";
	
			echo "<table>";
						echo "<tr><td valign='top' width='100px'>
			<img src='$row1[uimg]' alt='' class='uimg' height='100' width='100'/>
				<br/>
